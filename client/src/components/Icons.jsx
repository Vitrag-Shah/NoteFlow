export const Icons = {
  ...
  Cloud: ({ size = 20, className = '' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M17.5 19c3.037 0 5.5-2.463 5.5-5.5 0-2.91-2.261-5.321-5.12-5.485C17.404 4.387 14 1 10 1c-3.141 0-5.833 2.091-6.726 4.965C1.385 6.307 0 8.484 0 11c0 3.314 2.686 6 6 6h11.5z" />
    </svg>
  ),
